...
class DSA_MarkovEnv:
    def __init__(self, args):
        ...
        self.num_channels = 18#19#54#18##信道数#现在假设9channel，each agent观测3channel；但是又能观测整体channel
        self.num_channel = [18,18,18]#[8,8,8]#[18,18,18]#[6,6,6]
        ...
        self.share_observation_spaces = {
            'agent_0': MultiBinary(18),
            'agent_1': MultiBinary(18),
            'agent_2': MultiBinary(18),
        }
    ...
    def step(self, actions):
        ...
        s_obs=self.repeat(self.env.channel_state)
