...
class DSA_MarkovEnv:
    def __init__(self, args):
        ...
        self.num_channels =25 #25#18#25#18+self.senselength-1#19#54#18##信道数#现在假设9channel，each agent观测3channel；但是又能观测整体channel
        self.num_channel = [25,25,25,25,25,25]#[25,25,25]#[18,18,18]#[8,8,8]#[18,18,18]#[6,6,6]
        self.num_agents = 6##num_agents  agent
        ...
        self.agents = ['agent_0', 'agent_1', 'agent_2','agent_3', 'agent_4', 'agent_5']##当前活动智能体列表，每次环境实例中，只有部分智能体是活动的
        self.share_observation_spaces = {
            'agent_0': MultiBinary(32),
            'agent_1': MultiBinary(32),
            'agent_2': MultiBinary(32),
            'agent_3': MultiBinary(32),
            'agent_4': MultiBinary(32),
            'agent_5': MultiBinary(32),
        }
