...
class DSA_MarkovEnv:
    ...
    def step(self, actions):
        ...
        self.fail_TDMA_hist_1 = []
        self.fail_ALOHA_hist_1 = []
        ...
        self.fail_TDMA_hist_1 = self.env.fail_TDMA
        self.fail_ALOHA_hist_1 = self.env.fail_ALOHA
        ...
        self.fail_ALOHA = self.env.fail_ALOHA
        ...
        self.fail_PU_hist = self.fail_PU_hist1.reshape(-1,1)  # 将数组重新调整为列向量的形式
        self.fail_TDMA_hist1 = np.array(self.env.fail_TDMA)
        self.fail_TDMA_hist = self.fail_TDMA_hist1.reshape(-1, 1)
        self.fail_ALOHA_hist1 = np.array(self.env.fail_ALOHA)
        self.fail_ALOHA_hist = self.fail_ALOHA_hist1.reshape(-1, 1)
