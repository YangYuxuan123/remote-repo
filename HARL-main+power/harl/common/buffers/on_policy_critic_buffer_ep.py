...
class OnPolicyCriticBufferEP:
    ...
    def __init__(self, args, share_obs_space):
        ...
        self.use_gae = args["use_gae"]#True
        ...
        self.fail_collision_hist_1_episode = np.zeros(
            (self.episode_length, self.n_rollout_threads, 1), dtype=np.float32
        )
        self.success_hist_1_episode = np.zeros(
            (self.episode_length, self.n_rollout_threads, 1), dtype=np.float32
        )
    ...
    def insert(
        ...
        # fail_collision_hist_1.append(self.fail_collision_hist_1_episode[self.step]/self.num_agents/2000)
        # success_hist_1.append(self.success_hist_1_episode[self.step]/self.num_agents/2000)
